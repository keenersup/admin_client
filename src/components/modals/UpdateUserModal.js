...
import { useForm } from "../useCustomHooks/useForm";
...
/********* ********* ********* ********* ********* ********* ********* ********* *********
 for input focus border color change to basic color
 and javascript readOnly

 const StyledFormInputFocus = styled(Form.Input)`
 input:focus{
...
const UpdateUserModal = ({ open, setOpen, user, buttonStyle }) => {
  ...
  useEffect(() => {
    import("../../utils/getFingerprint").then(({ getFingerprint }) => {
